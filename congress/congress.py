...
class Congress():
    ...
    def __validate_params(self, params):
        ...
        Args:
            params (dict): User-specified parameter names and values to be propagated to __send_request()

        Returns:
            query_params (dict): Validated parameter names and values to be propagated to __send_request()
        """
        ...
        for param in params:
            if param in query_params:
                ...
                warn(f"Invalid parameter name '{param}' supplied. Will use default name and value instead.")
        return query_params
    ...
    def __process_request(self, url_prefix, path, params):
        """Processes requests to the Congress API. First validates the user-specified parameters, then composes a full URL of the endpoint, and finally sends the request to (and receives the response from) the Congress API.
